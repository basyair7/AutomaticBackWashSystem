...
void FSProgram::updateConfig(const String& cfile, std::function<void (StaticJsonDocument<500>&)> updateFunc)
{
...
void FSProgram::updateState(const String& cfile, std::function<void (StaticJsonDocument<200>&)> updateFunc)
{
 ...
 * -> false (disable)
*/
void FSProgram::changeConfigState(String stateConfig, bool value) {
...
void FSProgram::changeConfigAP(String NEWAPNAME, String NEWAPPASSWORD)
{
...
void FSProgram::changeConfigWifi(String NEWSSID, String NEWPASSWORD)
{
